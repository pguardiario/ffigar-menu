function GoalkeeperKits() {
  return <div className="grid grid-cols-6 gap-2 mt-2 mb-6 text-black bg-white shadow-sm shadow-gray-600 p-4">
    ...
    <div>
      <img className="img-responsive" src="https://images.discountfootballkits.com/1543318167_adi2019gknav.jpg" />
    </div>
    <div>
      <img className="img-responsive" src="https://images.discountfootballkits.com/1446740780_stannogk.jpg" />
    </div>
    <div>
      <img className="img-responsive" src="https://images.discountfootballkits.com/1617714467_pumagkkits.jpg" />
    </div>
    <div>
    ...
    <div>
      <h1 className="font-bold my-2 text-md">Adidas Goalkeeper Kits</h1>
      <ul className="text-left text-sm">
        <li><a href="/">Shirts</a></li>
        <li><a href="/">Socks</a></li>
        <li><a href="/">Shorts</a></li>
    ...
    <div>
      <h1 className="font-bold my-2 text-md">Stanno Goalkeeper Kits</h1>
      <ul className="text-left text-sm">
    ...
    <div>
      <h1 className="font-bold my-2 text-md">Jomo Goalkeeper Kits</h1>
      <ul className="text-left text-sm">
        <li><a href="/joma-football-kit/">Shirts</a></li>
        <li><a href="/joma-football-kit/">Socks</a></li>
        <li><a href="/joma-football-kit/">Shorts</a></li>
        <li><a href="/joma-football-kit/">Women's</a></li>
    ...
    <div>
      ...
      <ul className="text-left text-sm">
        ...
        <li><a href="/">Nike Base Layers</a></li>
        <li><a href="/">adidas Base Layers</a></li>
        <li><a href="/">Stanno Base Layers</a></li>
